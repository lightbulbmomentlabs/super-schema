          ...
          <div className="flex items-center justify-between py-3">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center border border-border">
                <svg className="h-8 w-8" viewBox="6.20856283 .64498824 244.26943717 251.24701176" xmlns="http://www.w3.org/2000/svg">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {hasHubSpotConnection
                    ? `Connected • ${hubspotConnections.length} account${hubspotConnections.length !== 1 ? 's' : ''}`
                    : 'Push schema directly to your HubSpot content'}
                </p>
              </div>
            </div>
            <button
